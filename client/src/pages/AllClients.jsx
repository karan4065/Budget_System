...
export function AllClients({ onOpenClientDetail, onOpenAddClient, onOpenNewLoan }) {
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-16">
      ...
      {/* Advanced Filter Bar (Search by Name, Number, Aadhaar + Date Filters) */}
            ...
            <table className="w-full text-left text-xs">
              <thead className="bg-slate-100 dark:bg-surface-950/80 border-b border-slate-200 dark:border-surface-800 text-slate-500 dark:text-slate-400 uppercase font-semibold tracking-wider">
                <tr>
                  ...
                  <th className="px-5 py-3.5">Contact & Aadhaar</th>
                  <th className="px-5 py-3.5">Total Loans</th>
                ...
                {clients.map((client) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Total Loans Count */}
                      <td className="px-5 py-4">
                        <span className="px-2.5 py-1 rounded-full text-xs font-bold bg-slate-100 text-slate-700 dark:bg-surface-800 dark:text-slate-300 border border-slate-200 dark:border-surface-700">
              ...
              return (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 bg-slate-50 dark:bg-surface-950/60 p-2.5 rounded-xl border border-slate-200 dark:border-surface-800 text-xs font-mono">
                    <div>
                      <p className="text-[10px] text-slate-400 uppercase font-sans">Total Borrowed</p>
